        ...
        <div style="width:100%; max-width:400px; background:linear-gradient(180deg, rgba(255,255,255,.09), rgba(255,255,255,.04)); border:1px solid rgba(255,255,255,.15); border-radius:24px; padding:28px; box-shadow:0 40px 80px -50px rgba(0,0,0,.95); animation:riseIn .4s ease both">
            ...
            <form wire:submit="login">
                <label style="display:flex; flex-direction:column; gap:7px; margin-bottom:12px">
                    <span style="font-size:12.5px; font-weight:700; color:#cdd7f0">نام کاربری</span>
                    <input wire:model="username" placeholder="admin" style="direction:ltr; background:rgba(6,14,36,.75); border:1.5px solid rgba(255,255,255,.16); border-radius:13px; padding:13px 14px; color:#fff; font-size:15px; outline:none">
                ...
                <label style="display:flex; flex-direction:column; gap:7px; margin-bottom:16px">
                    ...
                    <input wire:model="password" type="password" placeholder="••••" style="direction:ltr; background:rgba(6,14,36,.75); border:1.5px solid rgba(255,255,255,.16); border-radius:13px; padding:13px 14px; color:#fff; font-size:15px; outline:none">
                ...
                <button type="submit" wire:loading.attr="disabled" wire:target="login" style="width:100%; background:#d81f2a; color:#fff; font-weight:800; font-size:15.5px; border:none; border-radius:13px; padding:14px; cursor:pointer; box-shadow:0 14px 32px -14px rgba(216,31,42,.9)">
                    <span wire:loading.remove wire:target="login">ورود به پنل</span>
                    <span wire:loading.flex wire:target="login" style="align-items:center; justify-content:center; gap:8px">
                        <span aria-hidden="true" style="width:17px; height:17px; border:2px solid rgba(255,255,255,.35); border-top-color:#fff; border-radius:999px; animation:spin .7s linear infinite"></span>
                        در حال ورود...
                    </span>
                </button>
            </form>
