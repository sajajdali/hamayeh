...
Route::post('/otp/logout', [OtpController::class, 'destroy'])->name('otp.logout');
...
Route::get('/s/{blogger:code}/registration-state', [PublicRegistrationController::class, 'show'])->name('landing.registration-state');
Route::post('/s/{blogger:code}/registrations', [PublicRegistrationController::class, 'store'])->middleware('throttle:10,1')->name('landing.registrations.store');
Route::get('/s/{blogger:code}/my-ticket', [PublicRegistrationController::class, 'ticket'])->name('landing.ticket');
...
Route::get('/design/teachers/{image}', [ReferenceDesignController::class, 'teacherImage'])->where('image', '[A-Za-z0-9._-]+')->name('design.teacher-image');
Route::get('/design/seo/{image}', [ReferenceDesignController::class, 'seoImage'])->where('image', '[A-Za-z0-9._-]+')->name('design.seo-image');
